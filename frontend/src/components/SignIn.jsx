...
//   const [showPassword, setShowPassword] = useState(false);
//   const [formData, setFormData] = useState({ email: "", password: "" });
//   const [role, setRole] = useState("buyer"); // Add role state, default to buyer
...
//       // SAVE USER OBJECT (ID + ROLE IS IMPORTANT!)
//       const user = {
//         id: data.user._id,
...
//     let endpoint = "";
//     if (role === "buyer") {
//       endpoint = "http://localhost:8080/api/users/signin";
//     } else if (role === "seller") {
//       endpoint = "http://localhost:8080/api/seller/signin";
//     } else {
...
//     // Save JWT token (raw string)
//     localStorage.setItem("authToken", data.token);

//     // Save user object with explicit properties
//     localStorage.setItem("user", JSON.stringify({
//       id: data.user.id, // Explicitly include id
//       fullName: data.user.fullName, // Explicitly include fullName
//       email: data.user.email,
//       role: data.user.role,
//     }));
...
//         onClick={() => navigate("/")}
//       />
//       <div className="relative bg-white/90 backdrop-blur-xl rounded-xl shadow-2xl w-full max-w-md border border-white/30">
...
//         {/* Role Selector */}
//         <div className="flex gap-2 mb-4 text-sm px-4 pt-4">
//           <button
//             type="button"
      ...
      <div className="relative bg-white/90 backdrop-blur-xl rounded-xl shadow-2xl w-full max-w-md border border-white/30">
        ...
        <div className="flex gap-2 mb-4 text-sm px-4 pt-4">
          <button
            type="button"
            onClick={() => setRole("buyer")}
            className={`flex-1 py-1 rounded-lg font-medium ${
              role === "buyer"
